...
extern const int PENALTY_DOUBLED_PAWN;
extern const int PENALTY_DOUBLED_PAWN_EG;
extern const int PENALTY_ISOLATED_PAWN;
extern const int PENALTY_ISOLATED_PAWN_EG;
extern const int PENALTY_BACKWARD_PAWN;
extern const int BONUS_PASSED_PAWN;
extern const int BONUS_BISHOP_PAIR;
extern const int BONUS_ROOK_BEHIND_PASSED_PAWN;
extern const int BONUS_ROOK_ON_OPEN_FILE;
extern const int BONUS_PAWN_SHIELD_STRONG;
extern const int BONUS_PAWN_SHIELD_WEAK;
extern const int PAWN_OWN_DISTANCE[];
extern const int PAWN_OPPONENT_DISTANCE[];
extern const int KNIGHT_DISTANCE[];
extern const int BISHOP_DISTANCE[];
extern const int ROOK_DISTANCE[];
extern const int QUEEN_DISTANCE[];
...
extern int PAWNPOS_B_EG[64];
extern int KNIGHTPOS_B[64];
extern int KNIGHTPOS_B_EG[64];
extern int BISHOPPOS_B[64];
extern int BISHOPPOS_B_EG[64];
extern int ROOKPOS_B[64];
extern int QUEENPOS_B[64];
extern int KINGPOS_B[64];
extern int KINGPOS_ENDGAME_B[64];
extern const int rookMobScore[];
extern const int bishopMobScore[];
extern const int queenMobScore[];
...
extern const int STALEMATESCORE;
extern const int DRAWSCORE;
extern Move NOMOVE;
extern HashKeys KEY;

extern const int OFFSET;
extern const int MINCAPTVAL;
